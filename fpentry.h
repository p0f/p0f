...
#define QUIRK_EOL	0x00000001 /* E */
#define QUIRK_PAST      0x00000002 /* P */
#define QUIRK_ZEROID	0x00000004 /* Z */
#define QUIRK_IPOPT	0x00000008 /* I */
#define QUIRK_URG	0x00000010 /* U */ 
#define QUIRK_X2	0x00000020 /* X */ 
#define QUIRK_ACK	0x00000040 /* A */ 
#define QUIRK_T2	0x00000080 /* T */
#define QUIRK_FLAGS	0x00000100 /* F */
#define QUIRK_DATA	0x00000200 /* D */
#define QUIRK_BROKEN	0x00000400 /* ! */
